//CHECKSUM:163ff20456eec2f2294470a20af5fbaa1642322570aa7579ef3b5e05b754688b
"use strict";

const _ = require('lodash'); // Make sure slots exists exists
...
function extractIntentSlots() {
  ...
  for (let slot of slots) {
    ...
    event.state.session.slots[slot.name] = { ...slot,
      timestamp: Date.now(),
      turns: 0,
      overwritable: true,
...
//# sourceMappingURL=05_extract_slots.js.map